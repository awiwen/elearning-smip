...
// ketika tombol tambah user di klik
  $(document).on('click', '#id_BtnAddTugas', function(){
    ...
    jQuery.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/addtugas",
	...
	function GenDatatugas(){
		jQuery.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/showtugas",
            success: function(res) {
  ...
  function SaveTugas(){
    ...
    $(document).on('click', '#id_tugasbtn', function(e){
      ...
      if($('#id_FrmAddTugas').valid()){
			jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/savetugas",
        data: {
	...
	function DetailTugas(id){
		...
		jQuery.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/showdetailtugas",
				data: {
					id_list_tugas: id
				},
				success: function(res) {
  ...
  function EditTugas(id){
    ...
    jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/showedittugas",
        data: {
          id_list_tugas: id
        },
        success: function(res) {
	...
	function Updtugas(){
		jQuery.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/Edittugas",
			data: {
	...
	function UploadTugas(tugas_id){
			...
			jQuery.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/showupload",
					data: {
							tugas_id: tugas_id
					},
					success: function(res) {
	...
	function UploadPDF(tugas_id){
	    ...
	    $('#upload').on('click', function () {
	        ...
	        $.ajax({
	            url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/upload_file/"+tugas_id,
	            dataType: 'text',
	            cache: false,
	            contentType: false,
	            processData: false,
    ...
    jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/showtugasjawaban",
        data: {
          id_list_tugas: id
        },
        success: function(res) {
	...
	function Savejawaban(){
		...
		$(document).on('click', '#id_Btnjawaban', function(e){
			...
			jQuery.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/savejawaban",
				data: {
					id_tugas_id: $('#id_tugas_id').val(),
					id_tbuat: $('#id_tbuat').val(),
	...
	function UploadJawaban(tugas_jawaban_id){
			...
			jQuery.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/showuploadjawaban",
					data: {
	...
	function UploadPDFJawaban(tugas_jawaban_id){
			...
			$('#upload').on('click', function () {
					...
					form_data.append('file', file_data);
					$.ajax({
							url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/upload_jawaban/"+tugas_jawaban_id,
							dataType: 'text',
							cache: false,
							contentType: false,
							processData: false,
...
//Saat tombol Hapus di klik
  function Deltugas(id){
    ...
    if(delconf){
      jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>" + "index.php/ccrudtugas_p/deltugas",
        data: {
          id_list_tugas: id
        },
        success: function(res) {
