<div class="ts-main-content">
  <nav class="ts-sidebar">
    <ul class="ts-sidebar-menu">
      ...
      <li><a href="<?=base_url()?>index.php/ctrlpages/pengajar_p"><i class="fa fa-user"></i> Pengajar</a></li>
      <li><a href="<?=base_url()?>index.php/ctrlpages/tugas_s"><i class="fa fa-th-list"></i> Tugas</a></li>
      <li><a href="<?=base_url()?>index.php/ctrlpages/materi_s"><i class="fa fa-book"></i> Materi</a></li>
