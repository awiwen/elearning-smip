...
class Ccarimateri_p extends CI_Controller {
        ...
        <!-- Default box -->
          ...
          <div class="panel-body">
            ...
            $this->load->model('mcrudmateri');
                $query = $this->mcrudmateri->showmatericari_p($mapel->mapel_id,$kelas->kelas_id,$pengajar_id = $this->session->userdata('pengajar_id'));
            $i = 1;
