...
class Ccaridashboard_s extends CI_Controller {
...
public function showcaridashboard(){
  // echo $id;
  $this->db->query("UPDATE notifikasi set status_id=2 where login_id = '".$this->session->userdata('siswa_id')."'");
        ...
        <!-- Default box -->
          ...
          <div class="panel-body">
            ...
            $this->load->model('mcruddashboard');
                $query = $this->mcruddashboard->showdashboardcari_s($this->session->userdata('siswa_id'));
            $i = 1;
