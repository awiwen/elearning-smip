...
class Cdetailpengajar extends CI_Controller {
...
public function showdetailpengajar($id){
  echo $id;
      ...
      <section class="content-header" style="margin:100px 0 0 250px;">
        ...
        <h1>
         ...
         <ol class="breadcrumb">
          ...
          <li class="active">detailpengajar</li>
        </ol>
      </section>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              <?php
                ...
                $query=$this->mcrudpengajar->selectdetailpengajar($id);
